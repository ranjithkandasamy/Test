<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Colive.Website.lp.bangalore._default" EnableEventValidation="false" %>
...
<head>
    ...
    <title>Colive | Offers In Bangalore</title>
    ...
    <link rel="stylesheet" href="/assets/lp/bangalore/assets/css/style.css" />
    ...
    <form runat="server" id="EnquiryForm">
            ...
            <ProgressTemplate>
                <div id='loadingmsg' style="line-height: 0px;" class="">
                    <div style="position: relative;">
                        <img src="/assets/lp/bangalore/assets/images/loader.gif" />
                    </div>
                </div>
        ...
        <asp:UpdatePanel ID="upLandingPage" runat="server">
            <ContentTemplate>
                                        ...
                                        <div class="fieldWrap FormLocationLogo FAlignImage FOfferImgSize">
                                            <div id="ddlLocation" class="Fullwidth radioInputGroup text-white">
                                                <div class="lp-form-section">
                                                    <asp:DropDownList ID="ddlLocations" CssClass="lp-form-section" ClientIDMode="Predictable" AutoPostBack="false" runat="server" onchange="GetPropertiesByCoordinates();">
                                                    </asp:DropDownList>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="lp-img-row row">
                                        <div class="xlarge-6 large-6 medium-6 small-12 img-center">
                                            <div class="lp-img-size m-r1">
                                                <img src="/assets/lp/bangalore/assets/images/celebrate/party-1.png" class="img-fluid border-radius">
                                            </div>
                                        </div>
                                        <div class="xlarge-6 large-6 medium-6 small-12 img-center">
                                            <div class="lp-img-size m-l1">
                                                <img src="/assets/lp/bangalore/assets/images/celebrate/party-2.png" class="img-fluid border-radius">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <asp:HiddenField ID="hdnPropertyId" ClientIDMode="Static" runat="server" Value="0" />
                <asp:HiddenField ID="hdnLocation" ClientIDMode="Static" runat="server" Value="0" />
                <asp:HiddenField ID="hdnPropertyName" ClientIDMode="Static" runat="server" Value="" />
                <asp:HiddenField ID="hdnURL" ClientIDMode="Static" runat="server" Value="" />
            </ContentTemplate>
        </asp:UpdatePanel>
    </form>
    <script src="/assets/js/dcalendar.picker.js" defer></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.3.4/owl.carousel.min.js"></script>
    <script src="/assets/lp/bangalore/assets/js/custom.js" defer></script>
    <script id="rendered-js">
        jQuery(document).ready(function ($) {
            ...
            $('#faq-testimonials, #talk-testimonials').owlCarousel({
                ...
                dots: false,
                nav: true,
                navText: ["<img src='/assets/lp/bangalore/assets/images/right-thin-chevron.png'>", "<img src='/assets/lp/bangalore/assets/images/right-thin-chevron.png'>"],
