<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Colive.Website.lp.hyderabad._default" EnableEventValidation="false" %>
...
<head>
    ...
    <title>Colive | Offers In Hyderabad</title>
    ...
    <link rel="stylesheet" href="/assets/lp/hyderabad/assets/css/style.css" />
...
<body>
            ...
            <ProgressTemplate>
                <div id='loadingmsg' style="line-height: 0px;" class="">
                    <div style="position: relative;">
                        <img src="/assets/lp/hyderabad/assets/images/loader.gif" />
                    </div>
                </div>
                                            ...
                                            <div id="ddlLocation" class="Fullwidth radioInputGroup text-white">
                                                <div class="lp-form-section">
                                                    <asp:DropDownList ID="ddlLocations" CssClass="lp-form-section" runat="server">
                                                        ...
                                                        <asp:ListItem Text="Gachibowli" Value="lat=17.440081&long=78.348915&loc=Gachibowli"></asp:ListItem>
                                                        <asp:ListItem Text="Gowlidoddi" Value="lat=17.429195&long=78.325623&loc=Gowlidoddi"></asp:ListItem>
                                                        <asp:ListItem Text="Financial District" Value="lat=17.422066&long=78.338837&loc=Financial District"></asp:ListItem>
                                                        <asp:ListItem Text="Others" Value="lat=17.440081&long=78.348915&loc=Hyderabad"></asp:ListItem>
                                                    </asp:DropDownList>
                                            ...
                                            <div id="pplLocation" class="Fullwidth text-white">
                                                <div class="lp-form-section">
                                                    <asp:DropDownList ID="ddlProperty" CssClass="lp-form-section" runat="server" ClientIDMode="Predictable" onchange="PropertyChange();">
                                                        ...
                                                        <asp:ListItem Text="Colive 504 Garnet" Value="30835"></asp:ListItem>
                                                        <asp:ListItem Text="Colive 506 Ruby" Value="30863"></asp:ListItem>
                                                        <asp:ListItem Text="Colive 501 Elara" Value="30887"></asp:ListItem>
                                                    </asp:DropDownList>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="lp-img-row row">
                                        <div class="xlarge-6 large-6 medium-6 small-12 img-center">
                                            <div class="lp-img-size m-r1">
                                                <img src="/assets/lp/hyderabad/assets/images/celebrate/party-1.png" class="img-fluid border-radius">
                                            </div>
                                        </div>
                                        <div class="xlarge-6 large-6 medium-6 small-12 img-center">
                                            <div class="lp-img-size m-l1">
                                                <img src="/assets/lp/hyderabad/assets/images/celebrate/party-2.png" class="img-fluid border-radius">
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <script src="/assets/lp/hyderabad/assets/js/custom.js" defer></script>
    <script id="rendered-js">
        jQuery(document).ready(function ($) {
            ...
            $('#faq-testimonials, #talk-testimonials').owlCarousel({
                ...
                dots: false,
                nav: true,
                navText: ["<img src='/assets/lp/hyderabad/assets/images/right-thin-chevron.png'>", "<img src='/assets/lp/hyderabad/assets/images/right-thin-chevron.png'>"],
