<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="emailverification.aspx.cs" Inherits="Colive.Website.myaccount._emailverification" %>
...
<body>
            ...
            <div class="row">
                ...
                <div class="login-box col-lg-5 col-10 animated" id="loginotp-template">
                    ...
                    <form id="loginForm" name="loginForm" onsubmit="return false;">
                        <p class="text-center CustomerVerification">Hi <span class="text-center" id="spnCustomerName"></span>,</p>
                        <p class="text-center CustomerVerification"><span class="spnEmailVerify" id="spnEmailVerification"></span>
                          <br />                            
                        </p>                                                       
                    </form>
                </div>  
    ...
    <script>
        $(document).ready(function () {
            ...
            var mailid = querystring["mailid"];
            setTimeout(function () { VerifyCustomerEmail(Verificationlink,mailid) }, 1000);                                 
