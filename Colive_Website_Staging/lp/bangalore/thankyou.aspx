<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="thankyou.aspx.cs" Inherits="Colive.Website.lp.bangalore.thankyou" %>
...
<head runat="server">
    ...
    <link rel="stylesheet" href="/assets/lp/bangalore/assets/css/thankyou.css" />
    <script type="text/javascript">window.history.forward();</script>
    <script type="text/javascript" src="/assets/lp/bangalore/assets/js/jquery-3.4.1.min.js"></script>
    ...
    <form runat="server" id="EnquiryForm">
        <div class="navbar">
            <div class="ColiveContainer">
                <a href="/">
                    <img class="Colivelogo" src="/assets/lp/bangalore/assets/images/logo/logo-colive.png?d=20191024" />
                </a>
            </div>
        </div>
